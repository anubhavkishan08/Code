##brute force approach higher time complexity(o(mn)
#include<bits/stdc++.h>
using namespace std;
int main()
{
    long long int n,t,a,b,k,i;
    cin>>n>>t;
    vector<long long int> arr(n);
    unordered_set<long long int>arr1;
    while(t--)
    {
    ...
    //   for(auto it : arr1)
      //   cout<<it<<" ";
          ...
          cout<<*max_element(arr1.begin(),arr1.end());
}
##better approach of time-O(m+n)
#include<bits/stdc++.h>
using namespace std;
...
int main(){
   ...
   // long long *arr=new long long[n+2];
    vector<long long int> arr(n+2);  //Keep the size n+2 as we'll be using 1-indexed array and we're also accessing (b+1)th element
